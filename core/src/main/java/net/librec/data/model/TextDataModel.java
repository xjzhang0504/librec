...
public class TextDataModel extends AbstractDataModel implements DataModel {
	...
	/**
	 * Initializes a newly created {@code TextDataModel} object with configuration.
	 *
	 * @param conf
	...
	public void buildConvert() throws LibrecException {
		// String inputDataPath = conf.get(Configured.CONF_DFS_DATA_DIR) + "/" +
		// conf.get(Configured.CONF_DATA_INPUT_PATH);
       
		// Configured.CONF_DATA_INPUT_PATH  data.input.path   filmtrust/
		...
		dataConvertor = new TextDataConvertor(dataColumnFormat, StringUtils.join(inputDataPath, " "),
